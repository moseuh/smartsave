...
class ApiConfig {
  ...
  // Server URLs
  static const String localBaseUrl = 'http://192.168.100.11:3001/api';
  static const String remoteBaseUrl = 'https://dev.nebo.co.ke/api';
  ...
  static String userDetailsById(String userId) =>
      getUrl('user-details/$userId');
  ...
  static String userSavingsById(String userId) =>
      getUrl('user-savings/$userId');
  static String get savingsHistory => getUrl('savings-history');
  static String savingsHistoryById(String userId) =>
      getUrl('savings-history/$userId');
  static String get lastPayment => getUrl('last-payment');
  static String lastPaymentById(String userId) =>
      getUrl('last-payment/$userId');
  static String get roundupSettings => getUrl('roundup-settings');
  static String roundupSettingsById(String userId) =>
      getUrl('roundup-settings/$userId');
  ...
  static String savingsRecentById(String userId) =>
      getUrl('savings-recent/$userId');
  ...
  static String loanEligibilityById(String userId) =>
      getUrl('loan-eligibility/$userId');
  ...
  static String transactionStatus(String transactionId) =>
      getUrl('transaction-status/$transactionId');
  static String get uploadProfilePicture => getUrl('upload-profile-picture');
  static String uploadProfilePictureById(String userId) =>
  ...
  static String get manualLend => getUrl('manual-lend');
  static String get autoLend => getUrl('auto-lend');
}
